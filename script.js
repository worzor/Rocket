...
function end_desShow(){
    ...
    if(newY >= 9500 && newY < 9700){
        ...
        document.querySelector("#end").innerText = "ทะเลลึกเป็นแหล่งข้อมูลที่มีคุณค่าถึงพัฒนาการต่างๆของสิ่งมีชีวิตและมีข้อมูลควรค่าแก่การศึกษาในแง่เทคโนโลยีชีววิทยา การสูญพันธุ์เป็นสิ่งถาวร ย้อนคืนไม่ได้ เมื่อไหร่ก็ตามที่เราลดความหลากหลายทางชีววิทยาด้วยการทำให้สัตว์ชนิดหนึ่งสูญพันธุ์ไป เราก็ไปเปลี่ยนแปลงการพัฒนาการของสิ่งมีชีวิตบนโลกนี้";
    }else if(newY >= 10500 && newY < 10700){
        document.querySelector("#end").innerText = "การคงสภาพความหลากหลายทางชีวภาพใต้ทะเลลึกมีความสำคัญมากพอๆกับการดึงเอาทรัพยากรใต้ทะเลไปใช้ การศึกษาสำรวจใต้ทะเลลึกครั้งยาวนานนี้ หวังว่าผลการสำรวจที่ออกมาจะช่วยให้คุณ เข้าใจความสำคัญในการพิทักษ์ระบบนิเวศใต้ทะเลลึกไปพร้อมๆกับการใช้ทรัพยากรธรรมชาติ ว่าสิ่งเหล่านี้มีความสำคัญต่อการดำรงชีวิตอย่างไร";
    }else if(newY >= 10700){
